      ...
      <section className="bg-primary/5 py-16 md:py-24">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.6 }}
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-primary">聯絡我們</h1>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-lg mb-1">02-2345-6789</p>
                    <p className="text-sm text-foreground/60">週一至週日 10:00-21:00</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-lg mb-1">service@bonbunny.com</p>
                    <p className="text-sm text-foreground/60">我們會在24小時內回覆</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-foreground/80 text-lg mb-1">台北市大安區甜點街123號</p>
                    <p className="text-sm text-foreground/60">鄰近捷運科技大樓站</p>
                  </div>
                </motion.div>
              </div>
